  ...
  return (
    <>
      <section className="flex flex-col items-center justify-center w-screen h-auto mt-24 text-black lg:flex-row lg:items-start gap-30 lg:gap-10">
        ...
        <div className="flex flex-col items-start justify-start w-3/5 h-auto gap-4 mt-5 md:w-2/5">
          ...
          <h2 className='text-lg font-bold' data-aos="fade-up" data-aos-delay="400">+11.000 personas confían en nosotros.</h2>
