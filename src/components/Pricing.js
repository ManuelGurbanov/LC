  ...
  tiers: [
    {
      ...
      description: 'P',
      price: { arg: '$3.500 ARS', chi: '$1.805 CLP', col: '$15.640 COP', eurusd: '$4,00 USD/EUR' },
    ...
    },
    {
      ...
      href: 'https://www.instagram.com/monedas_fifalc/',
      description: 'P',
      price: { arg: '$7.000 ARS', chi: '$3.610 CLP', col: '$30.920 COP', eurusd: '$8,00 USD/EUR' },
      mainFeatures: ['Entrega rápida', 'Sin riesgo de Baneo'],
    },
    {
      name: '300K',
      ...
      price: { arg: '$10.500 ARS', chi: '$7.220 CLP', col: '$46.380 COP', eurusd: '$12,00 USD/EUR' },
      mainFeatures: ['Entrega rápida', 'Sin riesgo de Baneo'],
    },
    {
      name: '400K',
      href: 'https://www.instagram.com/monedas_fifalc/',
      description: 'P',
      price: { arg: '$14.000 ARS', chi: '$10.830 CLP', col: '$61.840 COP', eurusd: '$16,00 USD/EUR' },
      mainFeatures: ['Entrega rápida', 'Sin riesgo de Baneo'],
    },
    {
      name: '500K',
      href: 'https://www.instagram.com/monedas_fifalc/',
      description: 'P',
      price: { arg: '$17.500 ARS', chi: '$14.440 CLP', col: '$77.300 COP', eurusd: '$20,00 USD/EUR' },
      mainFeatures: ['Entrega rápida', 'Sin riesgo de Baneo'],
    },
    {
      name: '600K',
      href: 'https://www.instagram.com/monedas_fifalc/',
      description: 'Mejora tu plantilla rápidamente.',
      price: { arg: '$21.000 ARS', chi: '$18.050 CLP', col: '$92.760 COP', eurusd: '$24,00 USD/EUR' },
      mainFeatures: ['Entrega rápida', 'Sin riesgo de Baneo'],
    },
    {
      name: '700K',
      href: 'https://www.instagram.com/monedas_fifalc/',
      description: 'P',
      price: { arg: '$24.500 ARS', chi: '$21.660', col: '$108.220 COP', eurusd: '$28,00 USD/EUR' },
      mainFeatures: ['Entrega rápida', 'Sin riesgo de Baneo'],
    },
    {
      name: '800K',
      href: 'https://www.instagram.com/monedas_fifalc/',
      description: 'P',
      price: { arg: '$28.000 ARS', chi: '$25.270 CLP', col: '$123.680 COP', eurusd: '$32,00 USD/EUR' },
      mainFeatures: ['Entrega rápida', 'Sin riesgo de Baneo'],
    },
    {
      name: '900K',
      href: 'https://www.instagram.com/monedas_fifalc/',
      description: 'Mejora tu plantilla rápidamente.',
      price: { arg: '$31.500 ARS', chi: '$32.490 CLP', col: '$139.140 COP', eurusd: '$36,00 USD/EUR' },
      mainFeatures: ['Entrega rápida', 'Sin riesgo de Baneo'],
    },
    {
      name: '1M',
      href: 'https://www.instagram.com/monedas_fifalc/',
      description: 'Mejora tu plantilla rápidamente.',
      price: { arg: '$35.000 ARS', chi: '$36.100 CLP', col: '$154.600 COP', eurusd: '$40,00 USD/EUR' },
        ...
        {pricing.tiers.map((tier, index) => (
          <div
            ...
            className={classNames(
              ...
              'relative rounded-2xl w-full max-w-[300px] mx-auto'
            )}
          >
